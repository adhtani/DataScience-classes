...
geom_text(aes(label = paste0(Rating, " ", round(Race.Relations), "%")), position= position_stack(vjust = 0.6))
...
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(Rating, " ", round(Race.Relations), "%")), position= position_stack(vjust = 0.5))
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(axis.line = element_blank(),
axis.text = element_blank(),
...
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="bottom", axis.line = element_blank(),
axis.text = element_blank(),
axis.ticks = element_blank(),
plot.title = element_text(hjust = 0.5, color= "#666666"))
bp<- ggplot(df3, aes(x="", y=Race.Relations, fill=Rating))+
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(round(Race.Relations), "%")), position= position_stack(vjust = 0.5))
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="top", axis.line = element_blank(),
axis.text = element_blank(),
axis.ticks = element_blank(),
plot.title = element_text(hjust = 0.5, color= "#666666"))
bp<- ggplot(df3, aes(x="", y=Race.Relations, fill=Rating))+
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(Rating, " (", round(Race.Relations), "%)")))
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(Rating, " (", round(Race.Relations), "%)"), position= position_stack(vjust = 1)))
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(Rating, " (", round(Race.Relations), "%)")), position= position_stack(vjust = 0.1))
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar("y", start=0) +
geom_text(aes(label = paste0(Rating, " (", round(Race.Relations), "%)")), position= position_stack(vjust = 0.5), size=3.5)
pie + scale_fill_brewer(palette="Pastel1")+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Pie Chart: Approval Ratings for Race Relations")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
axis.ticks = element_blank(),
plot.title = element_text(hjust = 0.5, color= "#666666"))
ggdonutchart(df3, "Taxes", label = "Rating",
fill = "Rating", color = "white",
...
axis.ticks = element_blank(),
plot.title = element_text(hjust = 0.5, color= "#666666"))
bp<- ggplot(df3, aes(x="", y=Taxes, fill=Rating))+
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar(theta = "y") +
geom_text(aes(label = paste0(round(Taxes), "%")), position= position_stack(vjust = 0.5), size=3.5)
pie + scale_fill_manual(values=c("#55DDE0", "#F6AE2D", "#F26419"))+
...
pie <- bp + coord_polar(theta = "y") +
geom_text(aes(label = paste0(round(Taxes), "%")), position= position_stack(vjust = 0.5), size=3.5)
pie + scale_fill_manual(values=c("#55DDE0", "#999999", "#F26419"))+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Donut Chart: Approval Ratings for Taxes")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
axis.ticks = element_blank(),
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar(theta = "y") +
geom_text(aes(label = paste0(round(Taxes), "%")), position= position_stack(vjust = 0.5), size=3.5) + xlim(c(0.2, 4))
pie + scale_fill_manual(values=c("#55DDE0", "#999999", "#F26419"))+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Donut Chart: Approval Ratings for Taxes")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
...
geom_bar(width = 1, stat = "identity")
pie <- bp + coord_polar(theta = "y") +
geom_text(aes(label = paste0(round(Taxes), "%")), position= position_stack(vjust = 0.5), size=3.5) + xlim(c(0.2, 4.5))
pie + scale_fill_manual(values=c("#55DDE0", "#999999", "#F26419"))+
labs(x = NULL, y = NULL, fill = NULL, title = "R - Donut Chart: Approval Ratings for Taxes")+
theme_classic()+ theme(legend.position="right", axis.line = element_blank(),
axis.text = element_blank(),
...
df3 <- df3 %>%
mutate(x = hsize)
ggplot(df3, aes(x="", y=Taxes, fill=Rating))+
geom_bar(width = 1, stat = "identity")+
coord_polar(theta = "y")+
geom_text(aes(label = paste0(round(Taxes), "%")), position= position_stack(vjust = 0.5), size=3.5) + xlim(c(0.2, hsize+0.5))+
...
axis.ticks = element_blank(),
plot.title = element_text(hjust = 0.5, color= "#666666"))
savehistory("C:/Users/bibek/Documents/GitHub/DSC640/ex1-2/Assignment1.2.Rmd")
